...
@PropertySource(name = "com.vn.bpmcontrol", value = "classpath:/com/vn/bpmcontrol/module.properties")
public class BpmctlConfiguration {

    @Bean("bpmctl_BpmctlViewControllers")
    public ViewControllersConfiguration screens(final ApplicationContext applicationContext,
        ...
        viewControllers.setBasePackages(Collections.singletonList("com.vn.bpmcontrol"));
        return viewControllers;
    }

    @Bean("bpmctl_BpmctlActions")
    public ActionsConfiguration actions(final ApplicationContext applicationContext,
        ...
        actions.setBasePackages(Collections.singletonList("com.vn.bpmcontrol"));
        return actions;
    }
}
